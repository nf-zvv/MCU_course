...
Кроме того, при помощи этих битов можно настроить положительный/отрицательный дифференциальный вход АЦП, а также усиление сигнала.
...
Регистры содержат результат преобразования. В зависимости от состояния бита `ADLAR` регистра `ADMUX` выравнивание результата будет отличаться:
